...
public class ImageBannerWidget extends AppWidgetProvider {
    public static final String TOAST_ACTION = "com.mojopahit.cataloguiux.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.mojopahit.cataloguiux.EXTRA_ITEM";
