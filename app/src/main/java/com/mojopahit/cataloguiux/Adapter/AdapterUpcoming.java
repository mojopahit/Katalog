...
public class AdapterUpcoming extends RecyclerView.Adapter<AdapterUpcoming.VHolder> {
    private ArrayList<MainModel> mainModels;

    public AdapterUpcoming(ArrayList<MainModel> mainModels) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final AdapterUpcoming.VHolder holder, int i) {
        final int pos = i;
